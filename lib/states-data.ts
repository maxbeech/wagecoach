...
export const STATE_CORE: StateCore[] = [
  ...
  { slug: "west-virginia", name: "West Virginia", abbr: "WV", minWage: 8.75, minWageNote: "Applies to employers with 6+ non-exempt employees; others follow the federal $7.25.", tipCreditAllowed: true, tippedCashWage: 2.62, tippedNote: "West Virginia allows a tip credit up to 70% of the minimum wage (cash wage ≈ 30%).", dailyOt: null },
